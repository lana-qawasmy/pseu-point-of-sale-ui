        ...
        <div className="profilePage">
            <div className="userProfileContainer">
                ...
                >
                    ...
                    {showImageButtons && (
                        <div className="imageButtonsWrapper">
                            <label title='Change image' htmlFor="imageFile" className="btn">
                            ...
                            <button title='Remove image' className="btn" onClick={deleteImage}>
                ...
                <div className="personalInfoContainer">
                    <div>
                        <span title='Full name'>Full name</span>
                        <input
                            type="text"
                ...
                <div title='Edit password' className="passwordAnchor">
                    <span
                        onClick={() =>
                ...
                {showPasswordContainer && (
                    <div
                        className={`passwordContainer ${showPasswordContainer ? "slideIn" : "slideOut"}`}
                    >
                        <div>
                            <span title='Old password'>Old password</span>
                            <div>
                                <input
                        ...
                        <div>
                            <span title='New password'>New password</span>
                            <div>
                                <input
                        ...
                        <div>
                            <span title='Confirm password'>Confirm password</span>
                            <div>
                                <input
